...
public class KhoHang extends javax.swing.JPanel {
    StorageModel hanghoaModel;
     String queryData = "SELECT name_product, product_code, sum, retail_price, category FROM product";
    public KhoHang() {
        initComponents();
        hanghoaModel = new StorageModel();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Nhập mã sản phẩm hoặc tên sản phẩm ");
    ...
    private void jButtonViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonViewActionPerformed
        hanghoaModel.fetch_production_db(queryData, jTableProduct);
